...
def test_remove_users(test_app, test_database, add_user):
    test_database.session.query(User).delete()
...
def test_update_user_invalidate_json(test_app, test_database):
    client = test_app.test_client()
...
def test_update_user_invalidate_json_keys(test_app, test_database):
    client = test_app.test_client()
    resp = client.put(
        "/users/1",
